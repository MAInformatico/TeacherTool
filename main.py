...
def get_info(average_overall,average_reading,average_listening,average_speaking,average_writing,average_use_english):
        language_level, students, num_exam = get_initial_data()
